    ...
    >
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10 pt-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl lg:text-2xl text-gray-300 mb-12 animate-slide-up animation-delay-200">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up animation-delay-400">
            <button
              ...
              className="group px-8 py-4 bg-[#6EBF78] hover:bg-[#5DAF68] text-white font-semibold rounded-lg transition-all duration-300 flex items-center justify-center gap-2 shadow-lg shadow-[#6EBF78]/50"
            >
            ...
            <button
              ...
              className="px-8 py-4 bg-gray-700 hover:bg-gray-600 text-white font-semibold rounded-lg transition-all duration-300 flex items-center justify-center gap-2 border border-gray-600"
            >
              <Users size={20} />
              Collaborate With Us
            </button>
